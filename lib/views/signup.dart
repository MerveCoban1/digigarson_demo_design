        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(padding: EdgeInsets.only(left: width* 0.045), child:SignUpButton(
                  "assets/images/phone.png", Colors.green, "Phone number") ,),
              Padding(padding: EdgeInsets.only(left: width* 0.045), child:SignUpButton(
                  "assets/images/facebook.png", Colors.blue, "Facebook"),),
              Padding(padding: EdgeInsets.only(left: width* 0.045),child:SignUpButton("assets/images/google.png", Colors.red, "Google"),),
            ],
          ),
        ),
      ]),
